...
- (void)initUI {    
    self.btnImage.imageView.contentMode = UIViewContentModeScaleAspectFill;
    ...
    hud.center = CGPointMake(self.btnImage.frame.size.width / 2, self.btnImage.frame.size.height / 2);
    [self.btnImage addSubview:hud];
    [hud startAnimating];
